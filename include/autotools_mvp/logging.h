...
namespace std {
template <> struct hash<com::autotools_mvp::LogTag> {
...
public:
  ...
  mktmpdir(const boost::filesystem::path &model = "%%%%-%%%%-%%%%-%%%%");
   ...
   * @param[in] args A variadic list of args that can be written to a
                     \ref std::ostream.
   */
  template <typename... Ts> static void trace(const LogTag &tag, Ts &&...args) {
    std::stringstream ss;
   ...
   *                 \ref std::ostream.
   */
  template <typename... Ts> static void debug(const LogTag &tag, Ts &&...args) {
    std::stringstream ss;
    Logging::log_string_builder(ss, args...);
   ...
   *                 \ref std::ostream.
   */
  template <typename... Ts> static void info(const LogTag &tag, Ts &&...args) {
    std::stringstream ss;
    Logging::log_string_builder(ss, args...);
   ...
   *                 \ref std::ostream.
   */
  template <typename... Ts> static void warn(const LogTag &tag, Ts &&...args) {
    std::stringstream ss;
    Logging::log_string_builder(ss, args...);
   ...
   *             \ref std::ostream.
   */
  template <typename... Ts> static void error(const LogTag &tag, Ts &&...args) {
    std::stringstream ss;
    Logging::log_string_builder(ss, args...);
   ...
   *             \ref std::ostream.
   */
  template <typename... Ts> static void fatal(const LogTag &tag, Ts &&...args) {
    std::stringstream ss;
    Logging::log_string_builder(ss, args...);
